        ...
        <div className="flex flex-col h-full rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-xl bg-white">
            ...
            <div className="flex flex-col flex-1 p-6">
                ...
                <div className="mb-auto">
                    <h3 className="text-xl font-semibold text-gray-900 mb-3 hover:text-[#0E7A3B] transition-colors duration-300 line-clamp-2">
                        {title}
                    </h3>
                ...
                📍 <span className="text-gray-600">{location}</span>
                    ...
                    <div className="flex justify-end">
                        <a
                            ...
                            className="inline-flex items-center justify-center text-white rounded-lg bg-[#0E7A3B] px-6 py-2 transition-colors duration-300 hover:bg-[#096330] focus:ring-2 focus:ring-[#0E7A3B] focus:ring-offset-2"
                        >
                            View Event
                        </a>
                    </div>
