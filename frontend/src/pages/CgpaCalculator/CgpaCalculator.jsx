  ...
  const handleCalculateCGPA = () => {
    ...
    switch (true) {
      ...
      case cgpa >= 4.5:
        ...
        setResultBgStyle("bg-[#05BA05] w-3/4 text-[#05BA05]");
        break;
      case cgpa >= 3.5:
        setResultText("GOOD STANDING!");
        setResultBgStyle("bg-[#FDC553] w-2/4 text-[#FDC553]");
        break;
      case cgpa < 3.5:
        setResultText("NOT ON GOOD STANDING! - SEE YOUR ACADEMIC ADVISOR");
        setResultBgStyle("bg-[#F91F1F] w-1/4 text-[#F91F1F]");
        break;
  ...
  return (
    <div>
      ...
      >
          ...
          <div key={container.id}>
            <div className="flex-1">
              <div className="flex items-center justify-center py-1">
                <div
                  id="CGC-container"
                  className="rounded-lg w-[520px] max-h-[52px] mr-3 flex items-center"
                >
                  {/* course container */}
                  <div className="flex-1">
                    <input
        ...
        {/* Grade bar section */}
        <div>
          <div className="flex justify-between px-14 py-5" id="acad-stand">
