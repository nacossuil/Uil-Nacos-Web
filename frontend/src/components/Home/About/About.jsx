          ...
          <div className="sec1-content">
            <div>
              ...
              <p className="sec1-text">
                ...
                University of Ilorin Chapter, is the premier community for
                students of Computer Science, Computer Engineering,
                Telecommunication Science, Information Technology, and Computer
                Science Education. With over two decades of excellence and a
                strong national footprint, NACOSS Unilorin fosters a dynamic
                ecosystem for networking, professional growth, and innovative
                collaborations, shaping the next generation of tech leaders.
              </p>
              <a className="scroll-btn" href="#values-section">
                Learn More
                <BsArrowDown />
              </a>
            </div>
