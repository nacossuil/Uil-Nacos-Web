          ...
          <div className="sec1-content">
            <div>
              ...
              <p className="sec1-text">
                Nigeria Association of Computing Students (NACOS) Unilorin is
                the umbrella body for Unilorin students in Computer Science,
                Engineering, IT, and related fields. With a 20+ year legacy and
                nationwide presence, NACOS is your vibrant community for
                networking, growth, and innovation.
              </p>
              <button>
