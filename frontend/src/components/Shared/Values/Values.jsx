...
const values = [
    {
        icon: RocketSvg,
        title: "Our Mission",
        text: "Is to ignite the spark of innovation in emerging tech leaders, empowering them to revolutionize Nigeria's digital landscape with bold ideas, expertise, and passion!",
    },
    {
        icon: TargetSvg,
        title: "Our Aim",
